...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setStyleSheet("background-color: /icons/icons/BackGround.jpg")
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.mainCanvas = QtWidgets.QWidget(self.centralwidget)
        self.mainCanvas.setGeometry(QtCore.QRect(0, 35, 1024, 500))
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/icons/icons/Interview_Account_Setup.jpg"), QtGui.QIcon.Active, QtGui.QIcon.On)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/icons/icons/Current_Interview_Result_Edit.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        self.actionCurrent_Interview_Result_Edit.setIcon(icon6)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/icons/icons/Last_Interview_Report_View_logo.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        self.actionLast_Interview_Report_View.setIcon(icon7)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/icons/icons/Graphical_Visualization_View_logo.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        self.actionGraphical_Visualization_View.setIcon(icon8)
