...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.widget.setGeometry(QtCore.QRect(0, 4, 1061, 349))
        ...
        self.reactiionTimeCategoryLabel = QtWidgets.QLabel(self.widget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.category1Type1 = QtWidgets.QCheckBox(self.widget)
        self.category1Type1.setObjectName("category1Type1")
        self.verticalLayout.addWidget(self.category1Type1)
        self.category1Type2 = QtWidgets.QCheckBox(self.widget)
        ...
        self.physicalReactionsCategoryLabel = QtWidgets.QLabel(self.widget)
        ...
        self.category3Type1 = QtWidgets.QCheckBox(self.widget)
        self.category3Type1.setObjectName("category3Type1")
        self.verticalLayout_3.addWidget(self.category3Type1)
        self.category3Type2 = QtWidgets.QCheckBox(self.widget)
        ...
        self.updateExistingComplexIndicator = QtWidgets.QPushButton(self.widget)
        ...
        self.complexIndicatorToUpdate = QtWidgets.QLineEdit(self.widget)
        ...
        self.selectedTypeLabel = QtWidgets.QLabel(self.widget)
        ...
        self.addNewComplexIndicator = QtWidgets.QPushButton(self.widget)
        ...
        self.newComplexIndicatorToAdd = QtWidgets.QLineEdit(self.widget)
        ...
        self.selectedComplexIndicatorCategory = QtWidgets.QComboBox(self.widget)
        ...
        self.doneSetupButton = QtWidgets.QPushButton(self.widget)
        font = QtGui.QFont()
